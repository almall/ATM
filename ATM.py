...
df = pd.DataFrame(columns=['Transacción', 'Tipo', 'Balance', 'Transacción'])
...
while True:
        ...
        if opcion == 1:
            ...
            df = df.append({'Transacción': conteo, 'Tipo': ("Balance"), 'Balance':bal(balance_i), 'Transacción' : '0'}, ignore_index=True)
            print(df)
        elif opcion == 2:
            retiro = float(input("Cantidad a retirar: "))
            balance_i = retirada(balance_i, retiro)
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Retiro"), 'Balance':balance_i, 'Transacción' : -retiro}, ignore_index=True)
            print(df)
        elif opcion == 3:
            ingreso = float(input("Cantidad a depositar: "))
            balance_i = deposito(balance_i, ingreso)
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Depósito"), 'Balance':balance_i, 'Transacción' : ingreso}, ignore_index=True)
            print(df)
        elif opcion == 4:
            biz = float(input("Cobro BIZUM: "))
            balance_i = bizum_charge(balance_i, biz)
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("BIZUM +"), 'Balance':balance_i, 'Transacción' : biz}, ignore_index=True)
            print(df)
        elif opcion == 5:
            ...
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Transferencia externa +"), 'Balance':balance_i, 'Transacción' : transfer}, ignore_index=True)
            print(df)
        elif opcion == 7:
            transfer = float(input("Transferencia externa: "))
            ...
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Transferencia entre cuentas +"), 'Balance':balance_i, 'Transacción' : transfer}, ignore_index=True)
            print(df)
        elif opcion == 9:
            transfer = float(input("Transferencia entre cuentas: "))
            ...
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Recibo"), 'Balance':balance_i, 'Transacción' : -recibo}, ignore_index=True)
            print(df)
        elif opcion == 11:
            tarj = float(input("Cargo con tarjeta: "))
            balance_i = tarjeta(balance_i, tarj)
            conteo = conteo + 1
            df = df.append({'Transacción': conteo, 'Tipo': ("Pago con tarjeta"), 'Balance':balance_i, 'Transacción' : -tarj}, ignore_index=True)
            print(df)
        elif opcion == 12:
